...
router.post('/', authentifierRefreshToken, async(req, res, next)=>{
    try {
        const {payload, refreshTokenHashed} = req; // injecté par authentifierRefreshToken
        ...
        const [rows] = await pool.query(
            ...
            [payload.id_membre, refreshTokenHashed]
        );
        ...
        const accessToken = jwt.sign(
            { id: payload.id_membre, pseudo:payload.pseudo_membre, est_admin:payload.est_admin, type: 'access' },
